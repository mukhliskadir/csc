...
<head>
    ...
    <div class="headerr">
        <img src="ss.png" style="width: 400px;max-height: 100px;">
        <button class="account" name="signup" type="signup" onclick="signupAlert()">SIGN UP</button>
...
<div id="slideshow" style="width: 100%;height: 1000px;">
    <img class="mySlides" src="saga1.jpg" style="width:100%">
    <div class="search">
...
<form id="signform">
    ...
    <button type="cancel" class="cancel" onclick="location.href='index.html'">CANCEL</button>
...
<div id="signupform">
    <div class="msssg">
        ...
        <input type="number" name="ic" placeholder="Enter IC Number" required>
        <input type="number" name="phone" placeholder="Enter Phone Number"required>
        <textarea name="address" placeholder="Enter Address" required></textarea>
        <input type="text" name="license" placeholder="Enter License ID" required>
        <input type="text" name="Username" placeholder="Enter Username" required>
        <input type="password" name="Password" placeholder="Enter Password"required>
    </div>
    ...
    <button type="cancel" class="cancel" onclick="location.href='index.html'">CANCEL</button>
    <button type="submit" class="submit" onclick="location.href='index.html'">SUBMIT</button>
</div>
